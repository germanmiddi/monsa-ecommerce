          ...
          <div class="max-w-lg mx-auto lg:max-w-none">
            <section aria-labelledby="contact-info-heading">
              ...
              <div class="mt-6">
                ...
                <div class="mt-1">
                  <input type="text" id="name" name="name" v-model="form.name" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                </div>
              </div>
              <div class="mt-6">
                <label for="lastname" class="block text-sm font-medium text-gray-700">Apellido</label>
                <div class="mt-1">
                  <input type="text" id="lastname" name="lastname" v-model="form.lastname" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                </div>
              </div>
              <div class="mt-6">
                <label for="email-address" class="block text-sm font-medium text-gray-700">Email address</label>
                <div class="mt-1">
                  <input type="email" id="email-address" name="email-address" v-model="form.email" autocomplete="email" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                </div>
              </div>
              <div class="mt-6">
                <label for="cellphone" class="block text-sm font-medium text-gray-700">Telefono / Whatsapp</label>
                <div class="mt-1">
                  <input type="text" id="cellphone" name="cellphone" v-model="form.cellphone" autocomplete="email" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                </div>
              </div>
            ...
            <section aria-labelledby="shipping-heading" class="mt-10">
              ...
              <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-3">
                <div class="sm:col-span-3">
                  ...
                  <div class="mt-1">
                    <input type="text" id="address" name="address" v-model="form.address" autocomplete="street-address" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                  </div>
                </div>
                ...
                <div class="sm:col-span-3">
                  ...
                  <div class="mt-1">
                    <input type="text" id="addressNro" name="addressNro" v-model="form.addressNro" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                  </div>
                </div>
            ...
            <div class="mt-10 pt-6 border-t border-gray-200 sm:flex sm:items-center sm:justify-between">
              <button @click.prevent="submitCheckout"
                      type="submit" class="w-full bg-indigo-600 border border-transparent rounded-md shadow-sm 
                                          ...
                                          focus:ring-indigo-500 sm:ml-6 sm:order-last sm:w-auto">
                                          Continuar</button>
              <p class="mt-4 text-center text-sm text-gray-500 sm:mt-0 sm:text-left">Será redirigido a la ventana del pago.</p>
            </div>
          </div>
        </form>
      </main>
  ...
  export default {
    ...
    setup() {
      ...
      const submitCheckout = async () => {
        ...
        const url = route('checkout_payment')
